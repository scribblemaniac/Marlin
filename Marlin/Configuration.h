...
#define STRING_CONFIG_H_AUTHOR "(scribblemaniac, Ender-3 Octopus Pro v1.0)" // Original author or contributor.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 200, 70 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.5, -4, 0 }
